...
public class ManageClient extends javax.swing.JDialog {
        ...
        private void initComponents() {
                ...
                fieldLookFor = new javax.swing.JTextField();
        ...
        private void buttonSearchActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonSearchActionPerformed
                var selectedClient = fieldLookFor.getText();
                List<Client> clients = new ArrayList<>();

                try {
                        if (selectedClient.isEmpty()) {
                                Client client = getClientByNameQueries.getClientByName(selectedClient);
                                filterTableWithBooks(Collections.singletonList(client));
                                fieldLookFor.setText("");
                        } else {
                                clients = getAllClientsQueries.getListClients();
        ...
        private javax.swing.JTextField fieldLookFor;
